...
const short cFemurMin1[] PROGMEM = {
  cRRFemurMiPhoenix_Input_USB_Joystick.cppPhoenix_Input_USB_Joystick.cppn1, cRMRFemurMin1, cRMFFemurMin1, cRFFemurMin1, cLRFemurMin1, cLMRFemurMin1,  cLMFFemurMin1, cLFFemurMin1 };
const short cFemurMax1[] PROGMEM = {
